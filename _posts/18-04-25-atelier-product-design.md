...
![Page d'accueil d'un site qui loue des voitures. Il ya beaucoup de couleurs, des photos dans tous les sens, des flèches qui pointent dans toutes les directions. Bref, la page est illisible.](/img/design-site-affreux.jpg)
...
![Dessin très simple en blanc sur un fond noir. On y voit les parties émergée et immergée d'un iceberg. Une flèche, ayant pour légende UI, pointe la partie émergée. Deux bonhommes disent que "l'UX c'est comme un iceberg... il y a une partie invisible".](/img/design-schema-UX-UI.jpg)
...
![Une capture d'écran qui montre un point central vert duquel partent des traits qui aboutissent à des points bleus. A partir de ces points bleus, d'autres traits mènent à d'autres points bleus. En haut à gauche, un menu très simple indique les "tops bénéficiaires" et les "tops donneurs d'ordre"](/img/design-graph-Hopkins.jpg)
...
![Une capture d'écran qui montre une page blanche. Dans la partie inférieure, un cadre dans lequel on peut glisser-déposer un répertoire. Au-dessus, on trouve une description de l'outil](/img/design-stalactite.jpg)
...
![Une capture d'écran qui montre une carte sur laquelle on voit le "nombre total d'intervention par commune (par an) des pompiers en Essonne](/img/design-carto-Previsecours.jpg)
